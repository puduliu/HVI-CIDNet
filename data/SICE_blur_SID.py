...
# TODO edit start    
class SICEDatasetFromFolder_dual(data.Dataset):
    def __init__(self, data_dir, transform=None):
        super(SICEDatasetFromFolder_dual, self).__init__()
        self.data_dir = data_dir
        self.transform = transform
    ...
    def __getitem__(self, index):
        ...
        # 文件名
        _, file1 = os.path.split(data_filenames[index1])
        _, file2 = os.path.split(data_filenames[index2])
