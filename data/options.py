...
def option():
    ...
    parser.add_argument('--snapshots', type=int, default=1, help='Snapshots for save checkpoints pth') # TODO 10->1
    ...
    parser.add_argument('--data_train_SICE'         , type=str, default='/media/zyserver/data16t/lpd/download/SICE/Dataset/train')
    ...
    parser.add_argument('--data_val_SICE_mix'       , type=str, default='/media/zyserver/data16t/lpd/download/SICE/Dataset/eval/test')
    parser.add_argument('--data_val_SICE_grad'      , type=str, default='/media/zyserver/data16t/lpd/download/SICE/Dataset/eval/test')
    parser.add_argument('--data_val_SICE_test'      , type=str, default='/media/zyserver/data16t/lpd/download/SICE/Dataset/eval/test')
    ...
    parser.add_argument('--data_valgt_SICE_mix'     , type=str, default='/media/zyserver/data16t/lpd/download/SICE/Dataset/eval/target/')
    parser.add_argument('--data_valgt_SICE_grad'    , type=str, default='/media/zyserver/data16t/lpd/download/SICE/Dataset/eval/target/')
    parser.add_argument('--data_valgt_SICE_test'    , type=str, default='/media/zyserver/data16t/lpd/download/SICE/Dataset/eval/target/')
    ...
    parser.add_argument('--SICE_test', type=bool, default=True)
